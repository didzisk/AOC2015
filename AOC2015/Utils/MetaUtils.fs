...
let todayFilename day = @$"d:\Training\Aoc2015files\day{day}.txt"
let [<Literal>] keyFilename =  @"d:\Training\Aoc2015files\key.txt"
let getTodayInput day =
    ...
    if not (File.Exists(filename)) then
        task {
            ...
            let! response = client.GetStreamAsync($"/2015/day/{day}/input")
